            ...
            <>
                <div className="card-body text-center">
                    ...
                    {account ? (
                        ...
                        <a href="https://www.follyapes.com/" target="_blank" rel="noreferrer"  className="hero-btn btn1 mint-btn" style={{"width": "30%"}}>Join Community</a> 
                        </>
                        ) : 
                            <ConnectButton/>
                        }
        ...
        return (
            <>
                <div className="card-body text-center">
                    ...
                    {account ? (
                        <a href="https://www.follyapes.com/" target="_blank" rel="noreferrer" className="hero-btn btn1 mint-btn" style={{"width": "30%"}}>Go on The whitelist</a>) : 
                            <ConnectButton/>
                        }
                </div>
            </>
